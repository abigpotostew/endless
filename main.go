...
func main() {
	...
	r.HandleFunc("/author/{slug}", app.authorPageHandler).Methods("GET")
...
func (app *App) authorPageHandler(w http.ResponseWriter, r *http.Request) {
	// Get the author slug from the URL
	vars := mux.Vars(r)
	authorSlug := vars["slug"]

	// Look up the author by slug
	authorName, found := train.GetAuthorBySlug(authorSlug)
	if !found {
		http.NotFound(w, r)
		return
	}
	...
	// Generate 5 posts for the author
	posts, err := train.GenerateAuthorPagePosts(chain, authorName, 5)
	if err != nil {
		http.Error(w, "Failed to generate posts: "+err.Error(), http.StatusInternalServerError)
		return
	}
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Stories by ` + html.EscapeString(authorName) + ` - Endless Stories</title>
    
    <!-- SEO Meta Tags -->
    <meta name="description" content="Discover stories by ` + html.EscapeString(authorName) + `. A collection of unique narratives created with AI-powered Markov chains.">
    <meta name="keywords" content="stories, fiction, narrative, creative writing, ` + html.EscapeString(authorName) + `, endless stories">
    <meta name="author" content="` + html.EscapeString(authorName) + `">
    <meta name="robots" content="index, follow">
    <meta name="language" content="English">
    <meta name="revisit-after" content="1 day">
    <meta name="distribution" content="global">
    ...
    <meta property="og:url" content="` + html.EscapeString(getFullURL(r)) + `">
    <meta property="og:title" content="Stories by ` + html.EscapeString(authorName) + ` - Endless Stories">
    <meta property="og:description" content="Discover stories by ` + html.EscapeString(authorName) + `. A collection of unique narratives.">
    <meta property="og:site_name" content="Endless Stories">
    <meta property="og:locale" content="en_US">
    <meta property="profile:username" content="` + html.EscapeString(authorName) + `">
    
    <!-- Twitter -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Stories by ` + html.EscapeString(authorName) + ` - Endless Stories">
    <meta name="twitter:description" content="Discover stories by ` + html.EscapeString(authorName) + `. A collection of unique narratives.">
    <meta name="twitter:site" content="@endlessstories">
    ...
    <script type="application/ld+json">
    {
        ...
        "mainEntity": {
            "@type": "Person",
            "name": "` + html.EscapeString(authorName) + `"
        },
        "name": "Stories by ` + html.EscapeString(authorName) + `",
        "description": "Discover stories by ` + html.EscapeString(authorName) + `. A collection of unique narratives.",
        "url": "` + html.EscapeString(getFullURL(r)) + `",
        "publisher": {
            "@type": "Organization",
            "name": "Endless Stories"
...
<body>
    ...
    <nav class="breadcrumb" aria-label="Breadcrumb">
        <a href="/">Home</a> &gt; 
        <span aria-current="page">` + html.EscapeString(authorName) + `</span>
    </nav>
    
    <div class="header">
        <h1>Stories by ` + html.EscapeString(authorName) + `</h1>
        <p>Discover unique narratives from this world class writer</p>
    </div>
    ...
    <div class="footer">
        <p>Stories by ` + html.EscapeString(authorName) + ` • Explore unique narratives</p>
    </div>
</body>
</html>`
...
<body>
	...
	authorSlug := train.AuthorNameToSlug(story.Author)
	metadataHTML := `</h1>
        ...
        <div class="author" itemprop="author" itemscope itemtype="https://schema.org/Person">
            <a href="/author/` + html.EscapeString(authorSlug) + `" itemprop="name">` + html.EscapeString(story.Author) + `</a>
        </div>
